    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Клиент'), ('dispatcher', 'Диспетчер')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='taxi.driver')),
            ],
        ),
        migrations.CreateModel(
            name='Trip',
            fields=[
                ...
                ('routes', models.ManyToManyField(to='taxi.route')),
            ],
        ),
    ]
